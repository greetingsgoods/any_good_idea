...
Class mycodepartner_namemodule extends CModule{
	var	$MODULE_ID = 'mycodepartner.namemodule';
	var $MODULE_VERSION;
	...
	function __construct(){
		...
		$this->MODULE_NAME = Loc::getMessage("MYCODEPARTNER_NAMEMODULE_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("MYCODEPARTNER_NAMEMODULE_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("MYCODEPARTNER_NAMEMODULE_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("MYCODEPARTNER_NAMEMODULE_PARTNER_URI");
	...
	function UnInstallFiles(){
		...
		\Bitrix\Main\IO\Directory::deleteDirectory($_SERVER["DOCUMENT_ROOT"].'/bitrix/wizards/mycodepartner/');
	...
	function DoInstall(){
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("MYCODEPARTNER_NAMEMODULE_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("MYCODEPARTNER_NAMEMODULE_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall(){
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("MYCODEPARTNER_NAMEMODULE_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
?>